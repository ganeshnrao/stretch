...
div
  b-card.mb-3(v-for="(item, index) in exercises" :key="item.id")
    ...
    b-form-group(label="Hold" :label-cols="labelCols")
      b-form-input(type="number" v-model.number="item.hold" min="1" max="300")
    b-form-group(label="Repeat" :label-cols="labelCols")
      b-form-input(type="number" v-model.number="item.repeat" min="1" max="300")
    b-form-group(label="Rest" :label-cols="labelCols")
      b-form-input(type="number" v-model.number="item.rest" min="0" max="300")
    b-button-group
